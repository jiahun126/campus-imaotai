...
public class IMTLogFactory {
    ...
    public static void reservation(IUser iUser , String logContent , PushPlusApi.OperTypeEnum operTypeEnum) {
        ...
        operLog.setOper(operTypeEnum.getValue());
        ...
        if(operTypeEnum.isSend()){
            //推送
            PushPlusApi.sendNotice(iUser, operLog,operTypeEnum);
        }
    }
